      ...
      <SectionContainerLeft styles={{ marginTop: "20vh", zIndex: -2 }}>
        <div className={styles.whoWeAreSection}>
          ...
          <p className={styles.textContent}>
            ...
            engaged in delivering IT services to onshore and offshore Clients.
            We are specialized in the delivery of integrated solutions that
            leverage its expertise in BPO. We are offering our clients a unique
            advantage by our integrated approach in designing and implementing
            customized outsourcing solutions. We consult our clients to
            understand their needs and internal processes and build solutions
            accordingly and implement them while ensuring continuity in
            services. We are a fast-growing business entity providing Data
            publishing, Data entry and data conversion services in various
            domains by engaging with selected clients. We engage with selected
            clients where we are confident of adding value to their business.
          </p>
          ...
          <p className={styles.textContent}>
            ...
            cutting-edge, technology-driven healthcare services to every corner
            of India. With a commitment to enhancing individual and community
            well-being, we're dedicated to ushering in a new era of
            personalized, accessible healthcare solutions for all.
          </p>
        </div>
      </SectionContainerLeft>
