  ...
  return (
    <div className={styles.contentContainer}>
      ...
      <p className={styles.textContent}>
        ...
        ensuring that each person receives personalized attention and treatment
        that aligns with their unique healthcare needs. This commitment drives
        us to continually innovate and adapt our services to provide
      ...
      <p className={styles.textContent}>
        ...
        stringent standards of ethics and transparency is non-negotiable for us,
        nurturing a culture of trust and confidence among our valued users
      </p>
      <p className={styles.textContent}>
        At AAYUR CARE, we are driven by a vision of a world where health and
        care seamlessly intertwine with daily existence, empowering individuals
        to lead lives that are not just healthier, but also more joyful and
        purposeful.{" "}
      </p>
