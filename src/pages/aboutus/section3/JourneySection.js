    ...
    >
      <div className={styles.buildingContainer}>
        ...
        <div className={styles.buildingCenteredText}>
          Join our journey to make health accessible for all through technology.
        </div>
      </div>
      <FeatureCards />
      ...
      <p className={styles.textContent}>
        ...
        providers and patients. Our vision is to emerge as the foremost provider
        of pioneering and streamlined reimbursement solutions within the
        healthcare industry. We are committed to revolutionizing financial
        ...
        technologies, we aim to set the standard for excellence in reimbursement
        services, empowering our clients to focus on delivering high-quality
        care while we handle their financial needs with precision and
        dedication.
      </p>
      <br></br>
      <br></br>
      ...
      <p className={styles.textContent}>
        ...
        operational efficiency and financial performance for our clients. At the
        heart of our endeavor lies an unwavering dedication to excellence,
