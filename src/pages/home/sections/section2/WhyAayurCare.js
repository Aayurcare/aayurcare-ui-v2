    ...
    <div className={styles.contentSubContainer}>
      ...
      <div className={styles.tableItems}>
        ...
        <span className={styles.leftElement}>
          ...
          <p className={styles.innerText}>
            Complete Coverage: Includes doctor visits, hospital stays, meds, and
            preventive care.
          </p>
        </span>
        <span className={styles.rightElement}>
          ...
          <p className={styles.innerText}>
            Activate your health card within 48 hours to ensure you can quickly
            access the benefits it offers.
          </p>
        </span>
        <span className={styles.leftElement}>
