...
const IntroWelcomeSection = () => {
  return (
    <SectionContainerLeft styles={{ marginTop: "0px", zIndex: -1 }}>
      <div className={styles.introWelcomeContainer}>
        ...
        <p className={styles.introDescription}>
          At AAYUR CARE, we prioritize your well-being above all else. Our
          mission is to empower you to take control of your health and lead a
          fulfilling life. To facilitate this, we offer a range of meticulously
          crafted Health Packages that cater to various healthcare needs.
          Discover how our Health Packages can benefit you and your loved ones.
        </p>
